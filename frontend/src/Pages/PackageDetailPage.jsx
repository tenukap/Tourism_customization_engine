...
export default function PackageDetailPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setError('Package not found or backend not running.')
        } finally {
            setLoading(false)
        }
    }
    ...
    return (
        <div>
            <div className="relative h-screen max-h-[500px]">
                ...
                <div className="absolute inset-0 bg-black/50 flex flex-col items-end justify-end z-10 pb-10 px-10"></div>
                        ...
                        <div className="lg:col-span-2 flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div
                                        key={item.label}
                                        className="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition duration-300"
                                    >
